...
dataset=datasets.ImageFolder(root=data_path,transform=transform_norm)
...
def train(model,loader,val_loader,optimizer,epochs,device,criterion,checkpoint_path="best_perform_1.pth"):
    ...
    for epoch in range(epochs):
        ...
        if val_acc>best_val_acc:
            ...
            print(f"Best model at epoch {epoch+1} with val acc {val_acc:.2f}%")
